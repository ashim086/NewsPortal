...
export default function NewsCard() {
  ...
  useEffect(() => {
    ...
    async function fetchAllNews() {
      const res = await fetch(
        "https://newsportal-juir.onrender.com/api/news/allnews",
      );
      const data = await res.json();
      setNews(data.news);
    ...
    >
        ...
        >
          ...
          >
            ...
            <div className="flex space-x-4">
              ...
              <CircleUser />:{" "}
              <p className="font-bold px-3">
                {News[0]?.journalist.name ?? "Fetching latest news..."}{" "}
              </p>
            </div>
          </motion.div>
          <hr className="my-4" />
        ...
        >
          ...
          >
            ...
            <div className="flex space-x-4">
              ...
              <CircleUser />:{" "}
              <p className="font-bold px-3">
                {News[1]?.journalist.name ?? "Fetching latest news..."}{" "}
              </p>
            </div>
          </motion.div>
          <hr className="my-4" />
      ...
      >
        <div className="flex gap-8">
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="flex space-x-4">
                  ...
                  <CircleUser />:{" "}
                  <p className="font-bold px-3">
                    {News[2]?.journalist.name ?? "Fetching latest news..."}{" "}
                  </p>
                </div>
              </motion.div>
          ...
          {/* Right Column */}
          <motion.div className="flex-1 p-6 rounded-lg" variants={itemVariants}>
            <div className="space-y-6">
              <h1
              ...
              >
                ...
                <div className="flex space-x-4">
                  ...
                  <CircleUser />:{" "}
                  <p className="font-bold px-3">
                    {News[3]?.journalist.name ?? "Fetching latest news..."}{" "}
                  </p>
                </div>
              </motion.div>
