...
function Authorization() {
  ...
  async function HandleRegistration(event) {
    ...
    try {
      const validationResult = registrationSchema.parse({
        name,
        email,
        password,
        role,
  ...
  const inputClasses =
    "w-full py-3 px-5 pr-12 bg-gray-100 rounded-lg border-none outline-none text-base font-medium";
  const buttonClasses =
    "w-full h-12 bg-[#CBC8B9] rounded-lg shadow text-white font-semibold text-base hover:bg-[#bbb8a9] transition-colors";
